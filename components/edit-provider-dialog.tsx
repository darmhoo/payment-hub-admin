...
type EditProviderValues = z.infer<typeof editProviderSchema>;
...
export default function EditProviderDialog({
  ...
  useEffect(() => {
    if (!open || !provider || !selectedDriver || !providerConfig) {
      return;
    }
     ...
     */
    const settings: EditProviderValues['settings'] = providerConfig.fields.map((fieldConfig) => ({
      ...
      <DialogContent className="flex max-h-[85vh] flex-col overflow-hidden sm:max-w-2xl">
        ...
        >
          ...
          <DialogFooter>
            ...
            <Button type="submit" form="edit-provider-form" disabled={submitting}>
              {submitting ? (
                <>
                  <Loader />
                  Saving...
