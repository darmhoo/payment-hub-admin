...
import { Info, ArrowRight, Check, Clock3, X } from 'lucide-react';
  ...
  return (
    <section className="w-full max-w-md rounded-xl border-zinc-200 shadow-sm p-4">
      <div className="mb-4 flex items-center gap-1">
        <h3 className="text-sm font-semibold text-zinc-800">Recent Transactions</h3>
      ...
      <div className="space-y-3">
        {transactions.map((transaction) => (
          <div key={transaction.reference} className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[9px] text-zinc-500">{transaction.provider}</p>
            </div>
            ...
            <div className="shrink-0 text-right">
              ...
              <p className="text-[8px] text-zinc-400">{transaction.date}</p>
            </div>
          </div>
        ))}
      </div>
